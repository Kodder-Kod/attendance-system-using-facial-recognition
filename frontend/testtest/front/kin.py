...
class Home:
    def __init__(self, root):
        ...
        img = Button(self.home, image=render, cursor='hand2', text='Start Class', compound=TOP, height=100, width=210,
                     font=('Times', 12),
                     command=lambda: face())
        img.image = render
        ...
        render = ImageTk.PhotoImage(resize)
        img = Button(self.home, image=render, cursor='hand2', text='View', compound=RIGHT, height=25, width=140,
                     font=('Times', 12),
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(self.home, image=render, cursor='hand2', text='Download', compound=RIGHT, height=25, width=140,
                     font=('Times', 12),
                     command=lambda: show(view))
        img.image = render
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(view, image=render, cursor='hand2', text='Back', compound=LEFT, height=25, width=90,
                     font=('Times', 12),
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(sheet, image=render, cursor='hand2', text='Spread Sheet', compound=RIGHT, height=50, width=150,
                     font=('Times', 13),
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(fullsheet, image=render, cursor='hand2', text='Back', compound=LEFT, height=25, width=90,
                     font=('Times', 12),
        ...
        resize = load.resize((50, 50), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(managepro, image=render, text='Students', compound=TOP, height=105, width=210, cursor='hand2',
                     bg='#ffffff', font=('Times', 12),
        ...
        resize = load.resize((50, 50), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(managepro, image=render, text='Lectures', bg='#ffffff', compound=TOP, cursor='hand2', height=105,
                     width=210,
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(edit11, image=render, cursor='hand2', text='Back', compound=LEFT, height=25, width=90,
                     font=('Times', 12),
        ...
        def cursor(e):
            c_row = self.stable.focus()
            contents = self.stable.item(c_row, 'values')
            sname.set(contents[0])
            semail.set(contents[1])
            sregno.set(contents[2])
            scourse.set(contents[3])

        Button(edit11, text='Add', bg='green', cursor='hand2', fg='white', width=10, command=lambda: add()).place(x=20,
                                                                                                                  y=370)
        Button(edit11, text='Update', bg='blue', cursor='hand2', fg='white', width=10, command=lambda: update()).place(
            x=110, y=370)
        Button(edit11, text='Delete', bg='red', cursor='hand2', fg='white', width=10, command=lambda: delete()).place(
            x=200, y=370)
        Button(edit11, text='Clear', bg='orange', cursor='hand2', fg='white', width=10, command=lambda: clear()).place(
            x=290, y=370)
        ...
        Button(edit101, text='Show All', command=lambda: self.stfetch_data()).place(x=200, y=50)
        ...
        self.stable = Treeview(edit1010, column=('name', 'email', 'regno', 'course'), xscrollcommand=scroll_x,
                               yscrollcommand=scroll_y)
        ...
        self.stable.bind("<Double-1>", cursor)
        ...
        def supdate():
            ...
            cou = scourse.get()
            c_row = self.stable.focus()
            contents = self.stable.item(c_row, text='',values=(name,email,regno,cou))
            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "UPDATE students1 SET name=%s email=%s cou=%s  Where regno=%s", name,email,regno,cou
            cur.execute(jin)
            conn.commit()
            self.countcourse()
            self.cofetch_data()
        ...
        def sdelete():
            ...
            cou = scourse.get()
            c_row = self.stable.focus()
            contents = self.stable.item(c_row, text='', values=(''))

            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "DELETE from students1 WHERE name=%s email=%s cou=%s  regno=%s",name,email,cou,regno
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(edit22, image=render, text='Back', cursor='hand2', compound=LEFT, height=25, width=90,
                     font=('Times', 12),
                     command=lambda: self.show(self.manage))
        img.image = render
        img.place(x=0, y=0)
        ...
        def cursor(e):
            c_row = self.ltable.focus()
            contents = self.ltable.item(c_row, 'values')
            lname.set(contents[0])
            lemail.set(contents[1])
            lregno.set(contents[2])
            lcourse.set(contents[3])

        Button(edit22, text='Add', bg='green', fg='white', cursor='hand2', width=10, command=lambda: add2()).place(x=20,
                                                                                                                   y=370)
        Button(edit22, text='Update', bg='blue', fg='white', cursor='hand2', width=10, command=lambda: update2()).place(
            x=110, y=370)
        Button(edit22, text='Delete', bg='red', fg='white', cursor='hand2', width=10, command=lambda: delete2()).place(
            x=200, y=370)
        Button(edit22, text='Clear', bg='orange', fg='white', cursor='hand2', width=10, command=lambda: clear2()).place(
            x=290, y=370)
        ...
        Button(edit202, text='Show All', command=lambda: self.lecfetch_data()).place(x=200, y=50)
        ...
        self.ltable.bind("<Double-1>", cursor)
        ...
        def lupdate2():
            ...
            cou = lcourse.get()
            c_row = self.ltable.focus()
            contents = self.ltable.item(c_row, text='',values=(name,email,regno,cou))
            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "UPDATE lectures1 SET name=%s email=%s cou=%Where regno=%s", name,email,cou,regno
            cur.execute(jin)
            conn.commit()
            self.countcourse()
            self.cofetch_data()
        ...
        def ldelete2():
            ...
            cou = lcourse.get()
            c_row = self.ltable.focus()
            contents = self.ltable.item(c_row, text='', values=(''))

            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "DELETE from lectures1 WHERE name=%s email=%s regno=%s cou=#%s",name,email,regno,cou
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(edit33, image=render, text='Back', cursor='hand2', compound=LEFT, height=25, width=90,
                     font=('Times', 12),
                     command=lambda: self.show(self.manage))
        img.image = render
        img.place(x=0, y=0)
        ...
        def cursor(e):
            c_row = self.utable.focus()
            contents = self.utable.item(c_row, 'values')
            ucode.set(contents[0])
            uname.set(contents[1])
            ulecture.set(contents[2])
            ucourse.set(contents[3])


        Button(edit33, text='Add', bg='green', fg='white', width=10, cursor='hand2', command=lambda: add3()).place(x=20,
                                                                                                                   y=362)
        Button(edit33, text='Update', bg='blue', fg='white', width=10, cursor='hand2', command=lambda: update3()).place(
            x=110, y=362)
        Button(edit33, text='Delete', bg='red', fg='white', width=10, cursor='hand2', command=lambda: delete3()).place(
            x=200, y=362)
        Button(edit33, text='Clear', bg='orange', fg='white', width=10, cursor='hand2', command=lambda: clear3()).place(
            x=290, y=362)
        ...
        Button(edit303, text='Show All', command=lambda: self.unfetch_data()).place(x=200, y=50)
        ...
        self.utable.bind("<Double-1>", cursor)
        ...
        def uupdate3():
            ...
            c_row = self.utable.focus()
            contents = self.utable.item(c_row, text='',values=(code,name.lec,cou))
            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "UPDATE units1 SET name=%s lec=%s cou=%s Where code=%s",code, name ,lec,cou
            cur.execute(jin)
            conn.commit()
            self.countcourse()
            self.cofetch_data()
        ...
        def udelete3():
            ...
            c_row = self.utable.focus()
            contents = self.utable.item(c_row, text='', values=(''))

            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "DELETE from units1 WHERE  code =%s name=%s  lec=%s cou=%s",code, name, lec, cou
        ...
        resize = load.resize((20, 20), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(edit44, image=render, text='Back', cursor='hand2', compound=LEFT, height=25, width=90,
                     font=('Times', 12),
                     command=lambda: self.show(self.manage))
        img.image = render
        img.place(x=0, y=0)
        ...
        Button(edit44, text='Add', bg='green', fg='white', width=10, cursor='hand2', command=lambda: add4()).place(x=20,
                                                                                                                   y=300)
        Button(edit44, text='Update', bg='blue', fg='white', width=10, cursor='hand2', command=lambda: update4()).place(
            x=110, y=300)
        Button(edit44, text='Delete', bg='red', fg='white', width=10, cursor='hand2', command=lambda: delete4()).place(
            x=200, y=300)
        Button(edit44, text='Clear', bg='orange', fg='white', width=10, cursor='hand2', command=lambda: clear4()).place(
            x=290, y=300)
        ...
        Button(edit404, text='Show All', command=lambda: self.cofetch_data()).place(x=200, y=50)
        ...
        def cupdate4():
            name=cname.get()
            c_row = self.ctable.focus()
            contents = self.ctable.item(c_row, text='',values=(name))
            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "UPDATE course1 SET name=%s Where name=%s", name,name
            cur.execute(jin)
            conn.commit()
            self.countcourse()
            self.cofetch_data()
        ...
        def cdelete4():
            ...
            name = cname.get()
            c_row = self.ctable.focus()
            contents = self.ctable.item(c_row, text='', values=(''))

            conn = sa.connect(host="localhost", user="root", password="", database="Recon")
            cur = conn.cursor()
            jin = "DELETE from course1 WHERE name=%s",name
        ...
        Button(self.settings, text='Change Name', height=2, width=15, font=("times", 12),
               command=lambda: show(nameframe)).place(x=50, y=330)
        Button(self.settings, text='Change Email', height=2, width=15, font=("times", 12),
               command=lambda: show(emailframe)).place(x=50, y=410)
        Button(self.settings, text='Change Password', height=2, width=15, font=("times", 12),
               command=lambda: show(passwordframe)).place(x=50, y=480)
        ...
        Entry(passwordframe, textvariable=newpas, font=('Times', 14), width=20, bd=0, show="*").place(x=40, y=100,
                                                                                                      height=30)
        ...
        Entry(passwordframe, textvariable=conpas, font=('Times', 14), width=20, bd=0, show="*").place(x=40, y=160,
                                                                                                      height=30)
