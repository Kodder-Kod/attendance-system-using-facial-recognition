...
#######################################################################################################
    def countstudents(self):
        ...
        conn.commit()
        conn.close()
        Label(self.s,text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.s2, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.s3, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
    ...
    def countlecturer(self):
        ...
        conn.commit()
        conn.close()
        Label(self.t,text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.t2, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.t3, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
    ...
    def countunits(self):
        ...
        conn.commit()
        conn.close()
        Label(self.u,text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.u2, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.u3, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
    ...
    def countcourse(self):
        ...
        conn.commit()
        conn.close()
        Label(self.c,text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.c2, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
        Label(self.c3, text=rows, font=('Times', 12, 'italic'), bg='#ffffff').place(x=100, y=40)
