...
class Home:
    def __init__(self, root):
        ...
        load = Image.open("play-button.png")
        resize = load.resize((60, 60), Image.LANCZOS)
        ...
        load = Image.open("to-do-list (1).png")
        ...
        load = Image.open("table.png")
        resize = load.resize((40, 40), Image.LANCZOS)
        render = ImageTk.PhotoImage(resize)
        img = Button(sheet, image=render, cursor='hand2', text='Spread Sheet',compound=TOP, height=50, width=150, font=('Times', 13),
    ...
    '''CALL FIRST HOME PAGE FUNCTION'''
    def call(self):
        return self.show(self.home)
    ...
    def fin(self):
        ...
        load001p = Image.open("smart-farming.png")
        resize001p = load001p.resize((200, 200), Image.LANCZOS)
        render001p = ImageTk.PhotoImage(resize001p)
        img001p = Label(self.frame1, image=render001p, bg='slate blue')
        img001p.image = render001p
        ...
        load001p = Image.open("telephone-call.png")
        resize001p = load001p.resize((25, 25), Image.LANCZOS)
        render001p = ImageTk.PhotoImage(resize001p)
        img001p = Label(self.frame5, image=render001p, bg='#ffffff')
        img001p.image = render001p
        ...
        load001p = Image.open("data-science.png")
        resize001p = load001p.resize((200, 200), Image.LANCZOS)
        render001p = ImageTk.PhotoImage(resize001p)
        img001p = Label(self.frame4, image=render001p, bg='slate blue')
        img001p.image = render001p
        img001p.place(x=120, y=220)
